...
```{r}
pdf("4dataset1_20days_finalsize.pdf")
#plot the histogram
...
#plot the histogram
#ggplot(summary, mapping = aes(x = t)) + 
#  geom_ribbon(aes(ymin = log(X5), ymax = log(X95)), fill = "blue", alpha = 0.6) + 
#  geom_line(mapping = aes(x = t, y = log(IN_pred))) + 
#  geom_point(mapping = aes(y = log(cases))) + 
